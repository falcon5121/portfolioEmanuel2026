...
const Home = () => {
    return (
        <>
        <div className="w-full h-screen bg-slate-800 text-white px-24">
            ...
            <article className='w-6xl bg-yellow-500 h-[32rem] mx-auto mt-24 flex justify-between'>
                <div className='w-[34rem] h-full bg-red-500'>
                    <text className='w-full h-full justify-center flex-row'>
                        <h1 className='text-sky-400 text-5xl mt-18 bg-gray-200'>Hello <span className='text-white'>,</span> <span className='text-amber-300'>I'm Emanuel</span></h1>
